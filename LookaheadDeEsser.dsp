...
deEssFreq = knob_group(hslider("[1]deEsser freq[tooltip:]", 8000 , 3000, 15000 , 100));
deEssSideFreq = knob_group(hslider("[1]deEsser side freq[tooltip:]", 8000 , 3000, 15000 , 100));
deEsserQ = knob_group(hslider("[1]deEsser Q[tooltip:]", 1 , 0.1, 10 , 0.1));
